...
function addToViewPort(value) {
    if (vport.innerHTML == "0" && value != "+" && value != "-" && value != "*" && value != "/" && value != "." && value != "%") {
        ...
        if ((value == '/' || value == '*' || value == '+' || value == '-' || value == '.') && (vport.innerHTML.slice(-1) == '/' || vport.innerHTML.slice(-1) == '*' || vport.innerHTML.slice(-1) == '+' || vport.innerHTML.slice(-1) == '-' || vport.innerHTML.slice(-1) == '.')) {
